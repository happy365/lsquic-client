...
static const struct parse_packet_in_test tests[] = {
    ...
    {   .ppit_lineno     = __LINE__,
        ...
        .ppit_conn_id    = 0,
        .ppit_packno     = 0x9B,
        .ppit_header_sz  = 1 + 0 + 1,
        .ppit_data_sz    = 1 + 0 + 1 + 7,
        .ppit_bufsz      = 1 + 0 + 1 + 7,
        .ppit_quic_ver   = 0,
        .ppit_nonce      = 0,
    },
    ...
    {   .ppit_lineno     = __LINE__,
        ...
        .ppit_is_server  = 0,
        .ppit_header_sz  = 1 + 0 + 4,
        .ppit_bufsz      = 1 + 0 + 4 + 7,
        .ppit_data_sz    = 1 + 0 + 4 + 7,
        .ppit_pi_flags   = 0,
        .ppit_conn_id    = 0,
        .ppit_quic_ver   = 0,
        .ppit_nonce      = 0,
...
run_ppi_test (struct lsquic_mm *mm, const struct parse_packet_in_test *ppit)
{
    ...
    if (ppit->ppit_version < LSQVER_044)
        ...
        s = lsquic_Q044_parse_packet_in_begin(packet_in, ppit->ppit_bufsz,
                                            ppit->ppit_is_server, 8, &ppstate);
    else
        s = lsquic_ID17_parse_packet_in_begin(packet_in, ppit->ppit_bufsz,
                                            ppit->ppit_is_server, 8, &ppstate);
