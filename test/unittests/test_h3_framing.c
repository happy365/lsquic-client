...
static const struct parse_funcs *g_pf = select_pf_by_ver(LSQVER_ID19);
                ...
                unsigned initial_stream_window)
{
    ...
    tobjs->lconn.cn_version = LSQVER_ID19;
    tobjs->lconn.cn_esf_c = &lsquic_enc_session_common_id19;
