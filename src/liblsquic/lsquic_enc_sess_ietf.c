...
static const struct alpn_map {
    ...
    {   LSQVER_ID19, (unsigned char *) "\x05h3-19",     },
    {   LSQVER_VERNEG, (unsigned char *) "\x05h3-19",     },
};
...
iquic_esfi_handshake (struct enc_sess_iquic *enc_sess)
{
    ...
    const unsigned char *alpn;
    unsigned alpn_len;
    enum lsquic_hsk_status hsk_err;
    char errbuf[ERR_ERROR_STRING_BUF_LEN];
  ...
  err:
    ...
    enc_sess->esi_conn->cn_if->ci_hsk_done(enc_sess->esi_conn, hsk_err);
    return IHS_STOP;
}
...
const struct enc_session_funcs_iquic lsquic_enc_session_iquic_id19 =
{
...
const struct enc_session_funcs_common lsquic_enc_session_common_id19 =
{
