...
int
lsquic_Q044_parse_packet_in_long_begin (struct lsquic_packet_in *packet_in,
                ...
                struct packin_parse_state *state)
{
    ...
    /* This checks both packet length or the first version of the version
...
const enum QUIC_FRAME_TYPE lsquic_iquic_byte2type[0x100] =
{
    ...
    [0x16] = QUIC_FRAME_STREAM_ID_BLOCKED,
    [0x17] = QUIC_FRAME_STREAM_ID_BLOCKED,
